...
// Print EditorView.cpp : CPrintEditorView 클래스의 구현
//
...
CPrintEditorDoc* CPrintEditorView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
